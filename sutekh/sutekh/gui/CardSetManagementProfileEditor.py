# CardSetManagementProfileEditor.py
# -*- coding: utf8 -*-
...
class CardSetManagementProfileEditor(SutekhDialog):
    ...
    def __init__(self, oParent, oConfig):
        ...
        for sKey in self.__oConfig.cardset_list_options():
            ...
            aOptions.append((sKey,
                self.__oConfig.get_cardset_list_option_spec(sKey), bInherit))
    ...
    def _save_unsaved_changes(self):
        ...
        for sProfile, dValues in self.__dUnsavedChanges.items():
            ...
            for sKey, sValue in dValues.items():
                self.__oConfig.set_cardset_list_profile_option(sProfile,
                        sKey, sValue)
