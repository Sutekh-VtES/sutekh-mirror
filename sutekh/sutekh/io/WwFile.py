...
"""
Tools for dealing with unopened files that follow the White Wolf encoding conventions.
"""
...
class WwFile(object):
    """WwFile is a convenience class which has an .open(..) method which returns
       a file-like object with the encoding set correctly.
       """
    ...
    def open(self):
        if self.bFileObj:
            ...
            return codecs.EncodedFile(urllib2.urlopen(self.sfFile),'utf8','cp1252')
        else:
