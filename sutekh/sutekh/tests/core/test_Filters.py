        ...
        aTests = [
            ...
            (Filters.ClanFilter('Ministry'),
             [u"Aabbt Kindred", u"Abdelsobek", u"Amisa",
              u"Count Jocalo", u"Kemintiri (Advanced)"]),
            ...
            (Filters.DisciplineFilter('obf'),
             [u"Aaron Bathurst", u"Abd al-Rashid", u"Abdelsobek", u"Abebe",
              ...
              u"Baron Dieudonne", u"Cedric",  u"Count Jocalo",
            ...
            (Filters.MultiDisciplineFilter(['nec', 'qui']),
             [u"Abd al-Rashid", u"Abdelsobek", u"Abebe", u"Akram",
              u"Ambrogino Giovanni", u"Count Jocalo",
              u"Hektor", u"Kabede Maru"]),
            ...
            (Filters.MultiDisciplineLevelFilter([('obt', 'inferior'),
             ...
             [u"Aaron Bathurst", u"Aaron Duggan, Cameron's Toady", u"Aeron",
              ...
              u"Bronwen", u"Cedric", u"Claudia",
              u"Count Jocalo", u"Enkidu, The Noah",
            ...
            (Filters.SectFilter('Sabbat'),
             [u"Aaron Bathurst", u"Aaron Duggan, Cameron's Toady", u"Aeron",
              u"Alfred Benezri", u"Angelica, The Canonicus",
              u"Bronwen", u"Claudia", u"Enkidu, The Noah",
              u"Harold Zettler, Pentex Director", u"Hektor",
              u"New Blood", u"Sha-Ennu", u"Sheela Na Gig",
              u"The Siamese"]),
            (Filters.MultiSectFilter(['Sabbat', 'Independent']),
             [u"Aabbt Kindred", u"Aaron Bathurst",
              ...
              u"Bronwen", u"Claudia", u"Count Jocalo", u"Enkidu, The Noah",
              u"Harold Zettler, Pentex Director", u"Hektor",
            ...
            (Filters.MultiGroupFilter([4, 5]),
             [u"Aaron Bathurst", u"Abdelsobek", u"Abebe",
              ...
              u"Cedric", u"Cesewayo", u"Claudia", u"Crow",
              u'Earl "Shaka74" Deams', u"Enkidu, The Noah",
              u"Harold Zettler, Pentex Director", u"Hektor",
              u'Inez "Nurse216" Villagrande', u"Kabede Maru", u"Sha-Ennu",
              u"Sheela Na Gig"]),
            (Filters.CapacityFilter(2),
             [u"Aaron Duggan, Cameron's Toady", u"Claudia", u"New Blood",
              u"Sheela Na Gig"]),
            (Filters.MultiCapacityFilter([2, 1]),
             [u"Aaron Duggan, Cameron's Toady", u"Abombwe", u"Claudia",
              u"Necromancy", u"New Blood", u"Sheela Na Gig"]),
            ...
            (Filters.CostFilter(0),
             [u'Aabbt Kindred', u'Aaron Bathurst',
              ...
              u'Cedric', u'Cesewayo', u'Claudia', u'Count Jocalo',
              u'Crow', u'Dramatic Upheaval',
              u'Earl "Shaka74" Deams', u"Enkidu, The Noah",
              ...
              u'Rise of the Fallen', u"Sha-Ennu",
            ...
            (Filters.KeywordFilter('2 bleed'),
             [u"Ambrogino Giovanni", u"Count Jocalo", u"The Siamese"]),
