...
class FilterTests(SutekhTest):
    ...
    def test_basic(self):
        ...
        aTests = [
            ...
            (Filters.MultiExpansionRarityFilter([('Third', 'Uncommon'),
                ('Jyhad', 'Rare')]), [u"Aaron's Feeding Razor", u"Abbot",
                    u"Ghoul Retainer", u"Pier 13, Port of Baltimore"]),
            ...
            (Filters.MultiCostFilter([2, 5]), [u".44 Magnum", u"AK-47",
                u"Ghoul Retainer", u"Paris Opera House",
            ...
            (Filters.CostFilter(0), [u'Aabbt Kindred',
                ...
                u'Cesewayo', u'Earl "Shaka74" Deams', u"Enkidu, The Noah",
                ...
                u"Necromancy", u"Pariah", u"Predator's Communion",
                u"Rebekka, Chantry Elder of Munich", u"Sha-Ennu",
                u"The Siamese", u"Two Wrongs", u"Yvette, The Hopeless"]),
            ...
            (Filters.CostTypeFilter('Pool'), [u".44 Magnum", u"AK-47",
                u"Aaron's Feeding Razor", u"Ghoul Retainer", u"Gypsies",
                u"High Top", u"Ossian", u"Paris Opera House",
                u"Park Hunting Ground", u"Political Hunting Ground",
                u"Protracted Investment", u"Rock Cat",
                u'Scapelli, The Family "Mechanic"', u"The Path of Blood",
            ...
            (Filters.MultiCostTypeFilter(['Pool', 'Blood']), [u".44 Magnum",
                ...
                u"Ghoul Retainer", u"Gypsies", u"High Top", u"Living Manse",
            ...
            (Filters.KeywordFilter('unique'), [u"Aaron's Feeding Razor",
                u"Agent of Power", u"Gypsies", u"High Top", u"Ossian",
            ...
            (Filters.KeywordFilter('location'), [u"Living Manse",
                u"Paris Opera House", u"Park Hunting Ground",
                u"Pier 13, Port of Baltimore", u"Political Hunting Ground",
            ...
            (Filters.FilterNot(Filters.MultiCardTypeFilter(['Equipment',
                'Vampire'])), [u"Abandoning the Flesh", u"Abbot", u"Abjure",
                    ...
                    u"Aire of Elation", u'Anna "Dictatrix11" Suljic',
                    u'Earl "Shaka74" Deams', u"Ghoul Retainer" , u"Gypsies",
                    u"High Top", u'Inez "Nurse216" Villagrande', u"Necromancy",
                    u"Ossian", u"Paris Opera House", u"Park Hunting Ground",
                    u"Political Hunting Ground", u"Predator's Communion",
                    u"Protracted Investment", u"Raven Spy", u"Rock Cat",
                    u'Scapelli, The Family "Mechanic"', u"Shade",
                    u"The Path of Blood", u"The Slaughterhouse", u"Two Wrongs",
                    u"Vox Domini"]),
        ]
        ...
        self.assertEqual(Filters.MultiCardTypeFilter.get_values(), [u"Action",
            ...
            u"Master", u"Power", u"Reaction", u"Reflex", u"Retainer",
            u"Vampire"])
