    ...
    def test_basic(self):
        ...
        aTests = [
            ...
            (Filters.CostTypeFilter('Pool'), [u".44 Magnum", u"AK-47",
                u"Aaron's Feeding Razor", u"Gypsies", u"High Top", u"Ossian",
                u"Paris Opera House", u"Park Hunting Ground",
                u"Political Hunting Ground", u"Rock Cat",
            ...
            (Filters.CardTextFilter('strike'), [u".44 Magnum", u"AK-47",
                u"Aeron", u"Anastasz di Zagreb", u"Bronwen", u"High Top",
                u"Ossian", u"Rock Cat", u'Scapelli, The Family "Mechanic"',
                u"Shade"]),
            ...
            (Filters.FilterNot(Filters.MultiCardTypeFilter(['Equipment',
                'Vampire'])), [u"Abandoning the Flesh", u"Abbot", u"Abjure",
                    ...
                    u'Earl "Shaka74" Deams', u"Gypsies", u"High Top",
                    u'Inez "Nurse216" Villagrande', u"Necromancy", u"Ossian",
                    u"Paris Opera House", u"Park Hunting Ground",
