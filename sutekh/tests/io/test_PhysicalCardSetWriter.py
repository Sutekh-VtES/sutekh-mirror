...
EXPECTED_1 = """<physicalcardset author="A test author" name="Test Set 1" sutekh_xml_version="1.4">
  ...
  <card count="2" expansion="Jyhad" name="Immortal Grapple" printing="No Printing" />
  <card count="2" expansion="Keepers of Tradition" name="Immortal Grapple" printing="No Printing" />
  ...
  <card count="2" expansion="Third Edition" name="Swallowed by the Night" printing="No Printing" />
  ...
  <card count="2" expansion="Third Edition" name="Walk of Flame" printing="No Printing" />
</physicalcardset>"""
